        ...
        <ul class="navbar-nav samping sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapsePages" class="collapse show" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="input_obat_admin.php">Input Obat</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Input Obat</h1>

                    <form autocomplete="off" required="" method="POST" action="input_obat_admin_action.php">
                            <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputasal" placeholder="Masukkan Asal" required="" name="asal">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputHargaBeli" class="input">Harga Beli Obat</label>
                                <input type="number" min="0" class="form-control input" id="exampleInputHargaBeli" placeholder="Masukkan Harga Beli" required="" name="hargabeli">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPPN" class="input">PPN</label>
                                <select class="form-control input" id="ppn" name="ppn" id="exampleInputPPN">
                                    <option value="10" selected required="">10%</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" min="0" class="form-control input" id="exampleInputJumlah" placeholder="Masukkan Jumlah" required="" name="jumlah">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputTanggal" class="input">Tanggal Beli</label>
                                <input type="date" class="form-control input" id="exampleInputTanggal" placeholder="Masukkan Tanggal" required="" name="tanggal">
                            </div>
                            </div>
                        <!-- /.card-body -->
