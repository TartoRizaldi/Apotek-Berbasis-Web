        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form autocomplete="off" required="" method="POST" action="<?php echo "update_pegawai_kasir_admin_action.php?id_akun=".$dataupdate['id_akun']; ?>">
                            ...
                            <div class="form-group">
                                <label for="exampleInputNamaPegawai" class="input">Nama Pegawai</label>
                                <input type="text" class="form-control input" id="exampleInputNamaPegawai" placeholder="Masukkan Nama Pegawai" required="" name="nama" value="<?php echo $dataupdate['nama_akun']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputUsername" class="input">Username</label>
                                <input type="text" class="form-control input" id="exampleInputUsername" placeholder="Masukkan Username" required="" name="username" value="<?php echo $dataupdate['username_akun']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputPassword" class="input">Password</label>
                                <input type="text" class="form-control input" id="exampleInputPassword" placeholder="Masukkan Password" required="" name="password" value="<?php echo $dataupdate['password_akun']; ?>">
                            </div>
                        </div>
                        <!-- /.card-body -->
