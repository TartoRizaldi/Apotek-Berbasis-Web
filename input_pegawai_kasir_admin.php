            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item active" href="input_pegawai_kasir_admin.php">Input Pegawai Kasir</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Input Pegawai Kasir</h1>

                    <form autocomplete="off" required="" method="POST" action="input_pegawai_kasir_admin_action.php">
                            <div class="card-body">
                                    ...
                                    if($_GET['input'] == "success"){
                                        echo "
                                            ...
                                            <div class='alert alert-success alert-dismissible div1'>
                                                ...
                                                <strong>Berhasil menambahkan pegawai</strong>
                                            </div>
                                            </center>
                                        ";
                                    }
                                        ...
                                        echo "
                                            ...
                                            <div class='alert alert-danger alert-dismissible div1'>
                                                <button type='button' class='close' data-dismiss='alert'>&times;</button>
                                                <strong>Username pegawai sudah ada</strong>
                                            </div>
                                            </center>
                                        ";
                                    }
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control input" id="exampleInputNamaPegawai" placeholder="Masukkan Nama Pegawai" required="" name="nama">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" min="0" class="form-control input" id="exampleInputPassword" placeholder="Masukkan Password" required="" name="password">
                            </div>
                            </div>
                        <!-- /.card-body -->
